...
function postData(url, data) {
  return new Promise(function (resolve, reject) {
    ...
    request.setRequestHeader("Content-Type", "application/json"); // pass the data as JSON string
...
postData("https://apiapptrainingnewapp.azurewebsites.net/api/Products", prdData).then(function (resp) {
  console.log("Data Created ".concat(resp));
})["catch"](function (error) {
  console.log("Data Creation failed ".concat(error));
});
